...
import com.ecomerce.sportscenter.alert.OrderEmailService;
...
public class OrderServiceImpl implements OrderService {
    ...
    public void updateDeliveryStatus(Long orderId, DeliveryStatus status) {
        ...
        try {
            orderEmailService.sendOrderStatusUpdate(order);
            System.out.println("Email envoyé avec succès à " + order.getUser().getUsername());
        } catch (Exception e) {
            e.printStackTrace();
        }
